...
%  of N independent statistical moments. This distribution is 
...
function [lambda,Xpdf,Xsupp,Xcdf,Xcdfinv,Xprob,Entropy,Area] = ...
              MaxEnt_MomConstr(Xmin,Xmax,Nx,b,lambda0,alpha,tol,maxiter)
    ...
    % normalization condition phi_0(x) = 1
    g(:,1) = ones(Nx,1);
    
    % statistical constraints phi_n(x) = x.^n, n = 1...N
    for n = 2:N
        g(:,n) = Xsupp.*g(:,n-1);
    end
